...
void InitOpenGL()
{
	...
	// 텍스처 매핑 모드 설정
	glTexEnvf(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_MODULATE); // 옵션 : GL_MODULATE, GL_REPLACE
	...
	pImage = ReadBmpFile("./tex/dice.bmp", &w, &h);
...
void Render()
{
	...
	glScalef(1.3, 1.3, 1.3);  // Adjust the scale as needed
